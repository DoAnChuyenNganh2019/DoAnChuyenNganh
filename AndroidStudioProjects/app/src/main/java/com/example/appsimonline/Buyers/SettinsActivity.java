...
public class SettinsActivity extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo()
    {
        ...
        Toast.makeText(SettinsActivity.this, "Cập nhật thông tin cá nhân thành công", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        {
            Toast.makeText(this, "OOP!! Thử lại xem", Toast.LENGTH_SHORT).show();
    ...
    private void uploadImage()
    {
        ...
        progressDialog.setMessage("Chờ chút!! Hệ thống đang cập nhật thông tin của bạn");
