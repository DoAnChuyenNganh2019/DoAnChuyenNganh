...
import com.example.appsimonline.Interface.ItemClickListner;
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Products model) {
                        ...
                        holder.itemView.setOnClickListener( new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                builder.setTitle( "Bạn có muốn xét duyệt sim của người bán!!" );
        ...
        unverifiedProductsRef.child( productID )
                ...
                .addOnCompleteListener( new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText( AdminCheckNewProductsActivity.this, "Sim đã được xét duyệt và sẵn sàng để bán", Toast.LENGTH_SHORT ).show();
                    }
                } );
    }
